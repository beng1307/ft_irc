...
| Spec | Coverage |
| --- | --- |
| `edge_cases/53_outbound_backpressure_delivery.spec` | A paused client must receive every queued broadcast after resuming, while other clients remain responsive. |
