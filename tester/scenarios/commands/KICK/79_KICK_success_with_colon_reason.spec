...
C2 SEND JOIN #lobby
C2 EXPECT :Bob134!* JOIN #lobby
C1 WAIT_RECV :Bob134!* JOIN #lobby
...
C3 SEND JOIN #lobby
C3 EXPECT :Cha134!* JOIN #lobby
C1 WAIT_RECV :Cha134!* JOIN #lobby
C2 WAIT_RECV :Cha134!* JOIN #lobby

# Alice kicks Bob with colon reason
C1 SEND KICK #lobby Bob134 :Bad behavior in channel
C1 EXPECT :Ali134!* KICK #lobby Bob134 :Bad behavior in channel
C2 EXPECT :Ali134!* KICK #lobby Bob134 :Bad behavior in channel
C3 EXPECT :Ali134!* KICK #lobby Bob134 :Bad behavior in channel

# Bob is now no longer on channel, cannot PRIVMSG #lobby
C2 SEND PRIVMSG #lobby :Am I still here?
C2 EXPECT 404 Bob134 #lobby :Cannot send to channel
