...
C2 SEND JOIN #lobby
C2 EXPECT :Bob154!* JOIN #lobby
C1 WAIT_RECV :Bob154!* JOIN #lobby

# Alice sends pipelined duplicate KICK commands
C1 SEND KICK #lobby Bob154 :First kick
C1 EXPECT :Ali154!* KICK #lobby Bob154 :First kick
C2 EXPECT :Ali154!* KICK #lobby Bob154 :First kick

# Second KICK arrives when Bob is no longer in channel
C1 SEND KICK #lobby Bob154 :Second kick
C1 EXPECT 441 Ali154 Bob154 #lobby :They aren't on that channel
