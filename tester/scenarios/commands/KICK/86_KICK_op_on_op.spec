...
C2 SEND JOIN #lobby
C2 EXPECT :Bob141!* JOIN #lobby
C1 WAIT_RECV :Bob141!* JOIN #lobby

# Alice promotes Bob to operator (+o)
C1 SEND MODE #lobby +o Bob141
C1 EXPECT :Ali141!* MODE #lobby +o Bob141
C2 EXPECT :Ali141!* MODE #lobby +o Bob141

# Alice kicks operator Bob
C1 SEND KICK #lobby Bob141 :Demoted and kicked
C1 EXPECT :Ali141!* KICK #lobby Bob141 :Demoted and kicked
C2 EXPECT :Ali141!* KICK #lobby Bob141 :Demoted and kicked
...
C2 EXPECT 482 Bob141 #lobby :You're not channel operator
