...
C2 SEND JOIN #lobby
C2 EXPECT :Bob146!* JOIN #lobby
C1 WAIT_RECV :Bob146!* JOIN #lobby

# Alice promotes Bob to operator (+o)
C1 SEND MODE #lobby +o Bob146
C1 EXPECT :Ali146!* MODE #lobby +o Bob146
C2 EXPECT :Ali146!* MODE #lobby +o Bob146

# Alice kicks Bob
C1 SEND KICK #lobby Bob146 :Demoted
C1 EXPECT :Ali146!* KICK #lobby Bob146 :Demoted
C2 EXPECT :Ali146!* KICK #lobby Bob146 :Demoted
...
C2 EXPECT 482 Bob146 #lobby :You're not channel operator
