...
C2 SEND JOIN #lobby
C2 EXPECT :Bob123!* JOIN #lobby
C1 WAIT_RECV :Bob123!* JOIN #lobby

# Alice sends KICK with tab delimiter between channel and target
C1 SEND KICK #lobby	Bob123 :tab test
C1 EXPECT 403 Ali123 #lobby	Bob123 :No such channel
