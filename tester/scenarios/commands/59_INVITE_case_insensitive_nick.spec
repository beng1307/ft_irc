# 59_INVITE_case_insensitive_nick.spec
...
C1 SEND PASS 1234
C1 SEND NICK Alice59
C1 SEND USER alice59 0 * :Alice
C1 EXPECT 001 Alice59 :*
C1 SEND JOIN #priv59
C1 EXPECT :Alice59!* JOIN #priv59
C1 SEND MODE #priv59 +i
C1 EXPECT :Alice59!* MODE #priv59 +i

# Bob59 registers as mixed-case 'Bob59'
C2 SEND PASS 1234
C2 SEND NICK Bob59
C2 SEND USER bob59 0 * :Bob
C2 EXPECT 001 Bob59 :*

# Alice59 invites Bob59 using lowercase nickname 'bob59'
C1 SEND INVITE bob59 #priv59
C1 EXPECT 341 Alice59 bob59 #priv59
C2 WAIT_RECV :Alice59!* INVITE Bob59 :#priv59
C1 EXPECT_CONNECTED
C2 EXPECT_CONNECTED
