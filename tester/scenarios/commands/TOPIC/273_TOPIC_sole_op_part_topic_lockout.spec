...
C1 SEND JOIN #locked
C1 EXPECT :Ali374!* JOIN #locked
C1 SEND MODE #locked +t
C1 EXPECT :Ali374!* MODE #locked +t
C1 SEND TOPIC #locked :Permanent Locked Topic
C1 EXPECT :Ali374!* TOPIC #locked :Permanent Locked Topic
...
C2 SEND JOIN #locked
C2 EXPECT :Bob374!* JOIN #locked
C1 WAIT_RECV :Bob374!* JOIN #locked

# Alice parts the channel
C1 SEND PART #locked :Goodbye forever
C1 EXPECT :Ali374!* PART #locked :Goodbye forever
C2 WAIT_RECV :Ali374!* PART #locked :Goodbye forever

# Bob attempts to change topic in opless +t channel
C2 SEND TOPIC #locked :Bob374 Trying To Fix
C2 EXPECT 482 Bob374 #locked :You're not channel operator
...
C2 SEND TOPIC #locked
C2 EXPECT 332 Bob374 #locked :Permanent Locked Topic
