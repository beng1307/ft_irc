...
C1 SEND JOIN #room
C1 EXPECT 353 Ali170 = #room :@Ali170
C1 EXPECT 366 Ali170 #room :End of /NAMES list

C2 SEND JOIN #room
C1 WAIT_RECV :Bob170!* JOIN #room

# Alice promotes Bob to operator
C1 SEND MODE #room +o Bob170
C1 EXPECT :Ali170!* MODE #room +o Bob170
C2 EXPECT :Ali170!* MODE #room +o Bob170
...
C2 SEND MODE #room -o Ali170
C2 EXPECT 482 Bob170 #room :You're not channel operator

C2 SEND MODE #room +i
C2 EXPECT 482 Bob170 #room :You're not channel operator

# Verify Alice is still operator
C1 SEND KICK #room Bob170 :Demoted and kicked
C1 EXPECT :Ali170!* KICK #room Bob170 :Demoted and kicked
