...
C1 EXPECT :Ali004!* JOIN #selfops
C2 SEND JOIN #selfops
C2 WAIT_RECV :Bob004!* JOIN #selfops

# Alice removes her own operator status
C1 SEND MODE #selfops -o Ali004
C1 EXPECT :Ali004!* MODE #selfops -o Ali004
C2 WAIT_RECV :Ali004!* MODE #selfops -o Ali004

# Alice tries to op Bob now that she is un-opped (fails with 482)
C1 SEND MODE #selfops +o Bob004
C1 EXPECT 482 Ali004 #selfops :You're not channel operator
